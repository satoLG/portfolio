...
src/
  ...
  core/                 ← engine modules (Scene, Time, Input, Control, Audio, Dialog, UI, Debug, i18n, MediaPlayer, PhoneScreen, CoinTooltip)
  scene/                ← 3D scene components (Island, Ocean, Fire, Fish, Skybox, ProceduralGrass, Physics, SeaFloor, SeaFloorDecor)
