...
const translations: Record<Language, TranslationDict> = {
    'en-us': {
        ...
        'credits.subtitle': 'External assets used in this scene and who made them.',
        'credits.footer': 'Missing an author? Open an issue — the list lives in src/core/CreditsData.ts.',
        'credits.close': 'Close',
        'credits.pending': 'author to be filled in',
        'credits.licensePending': 'licence to confirm',
        'credits.atlasHint': 'Texture atlas:',
        'credits.group.models': '3D models',
        'credits.group.music': 'Music',
        'credits.group.sfx': 'Sound effects',
        'credits.group.images': 'Images & textures',
        'credits.group.fonts': 'Fonts',
        'credits.group.libraries': 'Libraries',
        'credits.section.surface': 'Surface',
        'credits.section.underwater': 'Underwater',
        'credits.section.character': 'Character',
        'credits.section.props': 'Props',
        'credits.section.radioPlaylist': 'Radio playlist',
        'credits.section.introMusic': 'Intro',
        'credits.section.uiSounds': 'Interface',
        'credits.section.worldSounds': 'Interactions',
        'credits.section.ambience': 'Ambience',
        'credits.section.characterSounds': 'Pug',
        'credits.section.sceneTextures': 'Scene textures',
        'credits.section.coverArt': 'Cover art',
        'credits.section.icons': 'Icons & logos',
    ...
    'pt-br': {
        ...
        'credits.subtitle': 'Assets externos usados nesta cena e quem os fez.',
        'credits.footer': 'Falta algum autor? Abra uma issue — a lista fica em src/core/CreditsData.ts.',
        'credits.close': 'Fechar',
        'credits.pending': 'autor a preencher',
        'credits.licensePending': 'licença a confirmar',
        'credits.atlasHint': 'Atlas de textura:',
        'credits.group.models': 'Modelos 3D',
        'credits.group.music': 'Músicas',
        'credits.group.sfx': 'Efeitos sonoros',
        'credits.group.images': 'Imagens e texturas',
        'credits.group.fonts': 'Fontes',
        'credits.group.libraries': 'Bibliotecas',
        'credits.section.surface': 'Superfície',
        'credits.section.underwater': 'Submerso',
        'credits.section.character': 'Personagem',
        'credits.section.props': 'Objetos',
        'credits.section.radioPlaylist': 'Playlist do rádio',
        'credits.section.introMusic': 'Introdução',
        'credits.section.uiSounds': 'Interface',
        'credits.section.worldSounds': 'Interações',
        'credits.section.ambience': 'Ambiente',
        'credits.section.characterSounds': 'Pug',
        'credits.section.sceneTextures': 'Texturas da cena',
        'credits.section.coverArt': 'Capas',
        'credits.section.icons': 'Ícones e logos',
