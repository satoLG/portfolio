...
function buildGUI(): void {
    ...
    const oceanActions = {
        copyOceanConfig: () => {
            ...
            const wlc  = waterlineColorUniform.value;
            const content = [
                ...
                `export const waterlineThickness = ${f(waterlineThicknessUniform.value as number)};`,
                `export const waterlineSoftness  = ${f(waterlineSoftnessUniform.value as number)};`,
                `export const waterlineColor     = { r: ${f(wlc.x)}, g: ${f(wlc.y)}, b: ${f(wlc.z)} };`,
                `export const waterlineIntensity = ${f(waterlineIntensityUniform.value as number)};`,
                ``,
                `// ── Reflection ────────────────────────────────────────────────────────────────`,
    ...
    const waterlineFolder = oceanFolder.addFolder('Waterline / Blur');
    const waterlineProxy = {
        ...
        get thickness() { return waterlineThicknessUniform.value as number; },
        set thickness(v) { waterlineThicknessUniform.value = v; },
        get softness() { return waterlineSoftnessUniform.value as number; },
        set softness(v) { waterlineSoftnessUniform.value = v; },
        get intensity() { return waterlineIntensityUniform.value as number; },
        set intensity(v) { waterlineIntensityUniform.value = v; },
        get colorR() { return waterlineColorUniform.value.x; },
        set colorR(v) { waterlineColorUniform.value.x = v; },
        get colorG() { return waterlineColorUniform.value.y; },
        set colorG(v) { waterlineColorUniform.value.y = v; },
        get colorB() { return waterlineColorUniform.value.z; },
        set colorB(v) { waterlineColorUniform.value.z = v; },
    };
    waterlineFolder.add(waterlineProxy, 'blurStrength', 0, 0.05, 0.0005).name('Blur Strength').listen();
    waterlineFolder.add(waterlineProxy, 'blurRadius', 0, 6, 0.1).name('Blur Radius').listen();
    waterlineFolder.add(waterlineProxy, 'blurOpacity', 0, 1, 0.01).name('Blur Opacity').listen();
    waterlineFolder.add(waterlineProxy, 'compositeOpacity', 0, 1, 0.01).name('Composite Opacity').listen();
    waterlineFolder.add(waterlineProxy, 'y', -1, 1, 0.005).name('Waterline Y').listen();
    waterlineFolder.add(waterlineProxy, 'thickness', 0, 0.2, 0.001).name('Line Thickness').listen();
    waterlineFolder.add(waterlineProxy, 'softness', 0, 0.3, 0.001).name('Line Softness').listen();
    waterlineFolder.add(waterlineProxy, 'intensity', 0, 3, 0.01).name('Line Intensity').listen();
    waterlineFolder.add(waterlineProxy, 'colorR', 0, 2, 0.01).name('Line Color R').listen();
    waterlineFolder.add(waterlineProxy, 'colorG', 0, 2, 0.01).name('Line Color G').listen();
    waterlineFolder.add(waterlineProxy, 'colorB', 0, 2, 0.01).name('Line Color B').listen();
    waterlineFolder.close();
